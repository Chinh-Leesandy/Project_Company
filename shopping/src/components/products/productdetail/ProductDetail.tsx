      ...
      {isFetching ? (
        ...
        <div className='d-flex justify-content-around'>
          ...
          <div className='info-product col-7 mt-3'>
            ...
            <span className='pt-3'>
              Giá bán: <strong style={{ color: 'coral' }}>{data.price}$</strong>
            </span>
            <div className='rating d-flex justify-content-between'>
              <div className='rate'>
                Đánh giá: <strong style={{ color: 'coral' }}>{data.rating.rate}/5</strong>
              </div>
              <div className='count'>
                Số sản phẩm đã bán: <strong style={{ color: 'coral' }}>{data.rating.count}</strong>{' '}
              </div>
            </div>
